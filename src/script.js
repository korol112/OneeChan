      ...
      show: function()
      {
        ...
        else
        {
          var overlay     = $("<div id=overlay>").bind("click", $SS.options.close),
            ...
            "<a href='" + ($SS.browser.gecko ? "https://github.com/Nebukazar/OneeChan/raw/master/builds/OneeChan.user.js" : "https://github.com/Nebukazar/OneeChan/") + "' id=update-link target='_blank'>Update</a><span class=link-delim> | </span>" +
