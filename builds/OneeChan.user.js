...
// @updateURL 	 https://github.com/Nebukazar/OneeChan/raw/master/builds/OneeChan.meta.js
// @downloadURL  https://github.com/Nebukazar/OneeChan/raw/master/builds/OneeChan.user.js
    ...
    $SS = {
        ...
        insertCSS: function() {
            ...
            $SS.bHideSidebar = $SS.location.sub !== "boards" ||
                $SS.location.board === "f";
            css = "div.post div.file .fileThumb{float:left;margin-left:10px;margin-right:20px;margin-bottom:1px}.fileText{margin-left:20px;margin-right:10px}.postContainer{display:block}.fixed.bottom-header body{padding-bottom:3em!important}div.post{margin:4px 0}:root:not(.reply-fit-width) #delform div.reply:not([hidden]){display:table!important}:root:not(.reply-fit-width) #delform .stub~div.reply:not([hidden]){display:none!important}div.thread{margin:0;clear:both;padding-bottom:8px;z-index:3}table.flashListing{border-spacing:1px;margin-left:auto;margin-right:auto}div.pagelist div.pages{padding:4px}div.pagelist,div.pagelist>div{float:left}div.pagelist>div span{padding:4px;display:inline-block}s{text-decoration:none!important}span.spoiler,s,s:not(:hover)>a,s:not(:hover)>.linkify{color:#000!important;background:none repeat scroll 0 0 #000!important}span.spoiler:hover,s:hover,span.spoiler:focus,s:focus{color:#fff!important}#globalMessage,.boardBanner{text-align:center}div.sideArrows{float:left;margin-right:2px;margin-top:0;margin-left:2px;opacity:.3}hr{clear:both}#boardNavDesktopFoot{clear:both}table{border-spacing:1px;margin-left:auto;margin-right:auto}.center{text-align:center!important}.middlead,.topad{margin-bottom:20px!important}body{margin-left:" + $SS.conf["Margin Left"] + "px;margin-right:" + $SS.conf["Margin Right"] + "px;margin-top:1px}.hasDropDownNav{margin-top:auto!important}.postInfo{padding:4px 12px 2px;display:block!important}.closed{text-align:center}.useremail::before{margin-bottom:-20px;display:inline-block}.summary{margin-left:2px}.expanded-image{position:relative}.fileThumb img{border-radius:2px;padding:2px 0 10px 10px}:root.expand-cover #qr{z-index:11!important}:root.expand-cover .expanded-image{z-index:9!important}:root.force-op .op::after{clear:both;content:'';display:block}.thread>.replyContainer,.threadContainer>.replyContainer{margin-bottom:" + $SS.conf["Margin Between Replies"] + "px!important}.postInfo+.inline{margin-left:20px!important}.inline .op>.postInfo,#qp .op>.postInfo{min-width:600px}.postMessage{margin:" + $SS.conf["Margin Post Message"] + "!important}:root.reply-fit-width .reply.post{display:block!important}:root.reply-fit-width .stub~.reply.post{display:none!important}.hasInline .inline>.replyContainer:not(.expanded-image):not(.hasInline) .reply.post,:root.reply-fit-width .reply.post{overflow:hidden!important}:root.reply-fit-width .hasInline>.reply.post,:root.reply-fit-width .expanded-image>.reply.post{overflow:visible!important}:root.reply-fit-width .expanded-image>.post::after,:root.reply-fit-width .hasInline>.reply.post::after{clear:both!important;content:''!important;display:block!important}.threadContainer .hide-reply-button{margin-left:-12px!important}:root.reply-hide .thread>.expanded-image>.reply,:root.reply-hide .thread>.hasInline>.reply{margin-left:12px!important}.threadContainer{margin-left:0!important;padding-left:20px!important}:root.reply-hide .thread>.threadContainer{margin-left:13px!important}:root.post-info .reply>.postInfo{box-shadow:inset rgba(0,0,0,.05) 0 -1px 2px;padding-top:2px!important}:root.backlink-bottom .post{position:relative;padding-bottom:2px}:root.backlink-bottom .container{position:absolute;bottom:2px;right:6px}.reply .menu-button i{position:relative;bottom:1px}:root.reply-fit-width .reply .container{padding-right:5px}.container{margin-left:-2px!important}.reply>.postInfo>.menu-button+.container:not(:empty){margin-left:-2px!important}:root:not(.reply-fit-width) .container{margin-left:0!important}:root.reply-fit-width .post .menu-button{float:right;margin-left:0;position:relative;left:5px}:root.reply-fit-width .post .menu-button{opacity:0}:root.reply-fit-width .post:not(:hover) .menu-button{transition:opacity .3s ease-out 0s!important}:root.reply-fit-width .post:hover .menu-button{opacity:1;transition:opacity .3s ease-in .1s!important}.prettyprint{padding:5px!important;display:inline-block;max-height:400px;overflow-x:auto;max-width:100%;vertical-align:middle}input[type=checkbox],input[type=submit],.riceCheck{cursor:pointer}input[type=checkbox],.riceCheck{display:inline-block;height:10px!important;position:relative;width:10px!important;border-radius:2px!important}.riceCheck{margin:2px 3px 0 0}#qr .riceCheck,#qr input[type=checkbox]{margin:3px 4px 0!important;vertical-align:baseline;position:relative;top:1px}#qr label{vertical-align:middle}input[type=checkbox]:checked::before,input[type=checkbox]:checked+.riceCheck::before{content:'';display:block;height:8px;margin:1px;width:8px}input[type=checkbox]:checked::before,input[type=checkbox]:checked+.riceCheck::before{background:" + $SS.theme.checkMark.get() + "!important}#header-bar{padding:4px 4px 5px!important}:root:not(.fixed) #header-bar{top:0;right:0;left:0;box-shadow:0 1px 2px rgba(0,0,0,.15);border-bottom:1px solid}:root.index.bottom:not(.autohide) body{padding-bottom:4em!important}:root.autohide body{padding-top:0!important;padding-bottom:0!important}:root:not(.fixed).right-sidebar #header-bar{right:300px}:root:not(.fixed).left-sidebar #header-bar{left:300px}#full-board-list>a,.navSmall>a{margin-left:2px}:root.fixed:not(.autohide):not(.bottom) #globalMessage{margin-bottom:20px!important}.qr-link{border-radius:3px;vertical-align:middle;padding:7px 12px 6px}#qr{box-shadow:none!important}#qr .close{padding:2px 3px 2px 4px!important}#qr input[type=submit]{height:22px!important;margin-top:1px}:root.vertical-qr #qr{position:fixed!important;right:0!important;bottom:26px;left:auto!important;top:auto!important}:root.vertical-qr #qr.autohide:not(:hover):not(.has-focus){position:fixed!important;transform:rotate(-90deg);transform-origin:bottom right;-webkit-transform:rotate(-90deg);-webkit-transform-origin:bottom right;right:0!important;bottom:300px!important;min-width:240px!important;width:240px!important}:root.vertical-qr #qr.autohide:not(:hover):not(.has-focus) select{max-width:120px!important}:root.vertical-qr.left-sidebar #qr.autohide:not(:hover):not(.has-focus){transform:rotate(90deg);-webkit-transform:rotate(90deg);left:-244px!important;bottom:50px!important;right:auto!important}:root.left-sidebar #qr{left:0!important;right:auto!important}:root.right-sidebar #qr{right:0!important;left:auto!important}:root.fade-qr #qr form{display:block!important}:root.fade-qr #qr.autohide:not(.has-focus):not(:hover){opacity:.2!important;transition:opacity .2s ease-in-out 1s}:root.expand-inputs .persona .field{transition:width ease-in-out 1s,max-width ease-in-out 1s}:root.expand-inputs .persona .field:focus{position:absolute;right:2px;left:2px;width:99%!important;min-width:99%!important;transition:width ease-in-out 1s,max-width ease-in-out 1s}#qr:not(.has-captcha) textarea{min-height:190px!important}:root.webkit #qr:not(.has-captcha) textarea{min-height:185px!important}:root.webkit #qr.has-captcha textarea.field{height:8.6em;min-height:.6em!important}:root.qr-background #qr{background:transparent!important;border:0}:root.qr-controls #qr label,:root.qr-controls #qr .close{display:none}div[style='float: right;']{float:none!important;margin-left:10px}hr{height:2px;width:600px;border:0!important}:root.reply-fit-width #unread-line{margin:auto;width:100%}#unread-line{margin-top:-3px!important;margin-bottom:-3px!important}.boardBanner .boardTitle{cursor:default;letter-spacing:-2px}#bannerCnt{border:0!important;margin:0 auto;width:300px;max-height:100px!important;max-width:100%}.boardBanner{width:300px;margin:auto}.boardBanner>img{border:0!important}:root.banner-opacity #bannerCnt,.bBanner{opacity:.5;transition:opacity .3s ease-out 0s}:root.banner-opacity #bannerCnt:hover,.bBanner:hover{opacity:1!important;transition:opacity .3s ease-in 0s}.pages strong>a{border-radius:3px}.pages strong>a:hover{opacity:.7!important;transition:opacity .3s ease-in 0s}.pagelist{margin:5px 10px 20px 1px;padding-bottom:inherit}.pages a{padding:5px 10px;margin-left:-1px}.next{border:0!important;position:relative}.next a{position:relative;right:5px}.prev{border:0!important;position:relative}.prev a{position:relative;right:5px}.prev a::after{content:'<';position:inherit;top:4px;left:1px}.next a::after{content:'>';position:inherit;top:4px;right:2px}.pagelist button,.pagelist button:hover{background:none!important;border:0!important;box-shadow:none!important;height:20px;width:20px}.pagelist span{opacity:.2}.cataloglink{margin-left:12px;border-radius:3px}.cataloglink a{color:" + $SS.theme.textColor.hex + "!important;font-weight:700}.cataloglink a:hover{color:" + $SS.theme.textColor.hex + "!important;opacity:.7!important;transition:opacity .3s ease-in 0s}table.flashListing{margin:auto!important}table.flashListing .highlightPost{background:rgb\(" + $SS.theme.mainColor.shiftRGB(-25) + ")!important}.flashListing>tbody{padding-top:200px}.flashListing td{padding-left:4px!important;padding-right:4px!important;text-align:center!important}#delform[action='https://sys.4chan.org/f/up.php'],#delform[action='https://sys.4chan.org/f/up.php'] .postblock{background:none!important;border:0!important;box-shadow:none!important}#mascot img,#mascotprev img{position:fixed;z-index:2;right:0;bottom:0}#mascot img{margin-bottom:" + $SS.mascot.offset + "px;margin-right:" + $SS.mascot.hoffset + "px;height:" + $SS.mascot.height + ";width:" + $SS.mascot.width + ";transform:" + $SS.mascot.flip + "}:root.left-sidebar #mascot img,:root.left-sidebar #mascotprev img{margin-left:" + $SS.mascot.hoffset + "px;margin-right:0!important}#mascotprev img{z-index:90!important}#mascot.previewing img{display:none}#delform{position:relative}:root:not(.left-sidebar):not(.right-sidebar) #delform{z-index:3}:root.left-sidebar #mascot img,:root.left-sidebar #mascotprev img{left:0;right:auto!important}:root.mascot-opacity #mascot img,:root.mascot-opacity #mascotprev img{opacity:.5;transition:opacity .3s ease-out 0s}:root.mascot-opacity #mascot img:hover,:root.mascot-opacity #mascotprev img:hover{opacity:1!important;transition:opacity .3s ease-in 0s}:root.ad-opacity .center img{opacity:.5;transition:opacity .3s ease-out 0s}:root.ad-opacity .center img:hover{opacity:1!important;transition:opacity .3s ease-in 0s}:root.show-ads .ad-cnt{margin-top:auto!important}:root.index div.navLinks{padding:5px;margin-left:auto;margin-top:auto}.desktop:not(.postInfo){margin-bottom:5px}.navLinks.navLinksBot.desktop{margin-top:10px;margin-bottom:5px}#hoverUI{z-index:12!important}:root.thumb-opacity .fileThumb{opacity:.5;transition:opacity .3s ease-out 0s}:root.thumb-opacity .fileThumb:hover{opacity:1;transition:opacity .3s ease-in 0s}.deleteform,.pages,.pagelist button,#full-board-list{font-size:0!important}.fileText,.summary{font-size:" + (($SS.conf["Font Size"] < 13) ? 11 : ($SS.conf["Font Size"] - 2)) + "px!important}.qr-link{font-size:14px!important}.tab-label,.options-button,.theme-preview,#oneechan-options input,#oneechan-options textarea,.hide-reply-button,.hide-thread-button{font-family:sans-serif!important;font-size:12px!important}.boardTitle{font-weight:400!important;font-size:28px!important}.prettyprint span{font-family:monospace!important;font-size:medium!important}#full-board-list{font-size:0!important}#full-board-list a,body>#header-bar,#full-board-list .fourchanx-link{font-size:" + (($SS.conf["Font Size"] < 13) ? 12 : ($SS.conf["Font Size"] - 1)) + "px!important}body,.prev span::after,.prev form::after,.next span::after,.next form::after,.pages a,#qr input.field,#qr textarea.field,#qr span.field,#qr input[type=submit],#menu .entry,.boardTitle{font-family:" + $SS.formatFont($SS.conf["Font Family"]) + ";font-size:" + $SS.conf["Font Size"] + "px}#qr .field::-moz-placeholder,::-moz-placeholder{font-family:" + $SS.formatFont($SS.conf["Font Family"]) + "!important;font-size:" + $SS.conf["Font Size"] + "px!important}#qr .field::webkit-input-placeholder,::webkit-input-placeholder{font-family:" + $SS.formatFont($SS.conf["Font Family"]) + "!important;font-size:" + $SS.conf["Font Size"] + "px!important}:root.underline-disabled a{text-decoration:none!important}:root.underline-disabled .filtered{text-decoration:line-through!important}:root.underline-quotes .deadlink.quotelink,:root.underline-quotes .quotelink{text-decoration:underline!important}.name,.subject,.option.header .option-title,a.current{font-weight:" + ($SS.conf["Bitmap Font"] ? 4 : 7) + "00!important}.summary{font-style:" + ($SS.conf["Bitmap Font"] ? 'none' : 'italic') + "}a.quotelink.forwardlink,a.backlink.forwardlink{border-bottom:1px dashed}.mobile,#delform .mobile.center,.brackets-wrap:not(.hide-board-list-container)::before,.brackets-wrap:not(.hide-board-list-container)::after,.tab-select:not(:checked)+div,iframe[src='about:blank'],#absbot,.stylechanger,#styleSwitcher,#togglePostFormLink,:root:not(.show-ads) .center,:root.show-ads.hide-top .topad.center,:root.show-ads.hide-middle .middlead.center,:root.show-ads.hide-bottom .bottomad.center,#delPassword,:root.hide-prevnext .prev,:root.hide-prevnext .next,:root.hide-blotter #blotter,:root.hide-checkboxes #delform .post input[type=checkbox],:root.hide-checkboxes #delform .post .riceCheck,:root.hide-checkboxes #qp .post input[type=checkbox],:root.hide-checkboxes #qp .riceCheck,:root.hide-checkboxes .deleteform,:root.hide-board-name .boardTitle,:root.hide-board-name .boardSubtitle,:root.hide-banner #bannerCnt,:root.hide-button .qr-link-container,:root.reply-fit-width .sideArrows,#postForm,.forwarded,hr:not(#unread-line),:root.hide-navlinkbot .navLinks.navLinksBot.desktop,:root.hide-navlinks .navLinks,:root.hide-navlinks .desktop:not(.pagelist),.ad-plea,#mascot img[src=''],.exif:not([style]){display:none}input:focus,textarea:focus,a{outline:0!important}:root.hl-border .replyContainer{border-left:" + $SS.conf["Width Decoration"] + "px " + $SS.conf["Highlight Style"] + " rgba(" + $SS.theme.highlightColor.rgb + ",1)}:root.hl-outline .replyContainer{outline:" + $SS.conf["Width Decoration"] + "px " + $SS.conf["Highlight Style"] + " rgba(" + $SS.theme.highlightColor.rgb + ",1)}:root.highlight-own .yourPost>.reply,:root.highlight-you .quotesYou>.reply{border-left:" + $SS.conf["Width Decoration"] + "px " + $SS.conf["Highlight Style"] + " rgba(" + $SS.theme.tripColor.rgb + ",1)!important;border-top-color:rgba(" + $SS.theme.tripColor.rgb + ",1)!important;border-bottom-color:rgba(" + $SS.theme.tripColor.rgb + ",1)!important}.reply:target{background:rgba(" + $SS.theme.nameColor.rgb + ",.3)!important}.highlight{outline:2px solid rgba(" + $SS.theme.tripColor.rgb + ",1)!important}div[style='float: right;']{color:transparent!important}html,body,.boardBanner,#menu,input:not(.jsColor),textarea,#qr-filename-container,#post-preview,.post-last,.pln{color:" + $SS.theme.textColor.hex + "!important}.nameBlock>.name,.com,.post-author,:root.email-color a.useremail .name{color:" + $SS.theme.nameColor.hex + "!important}.nameBlock>.postertrip,:root.email-color a.useremail .postertrip,.post-tripcode,.tag{color:" + $SS.theme.tripColor.hex + "!important}a,.typ,.atn,:root.catalog .button,.options-button{color:" + $SS.theme.linkColor.hex + "!important}a.summary,.pages strong>a{color:" + $SS.theme.textColor.hex + "!important}#header-bar #notifications a{color:#fff!important}a:hover,:root.catalog .button:hover,.lit,#header-bar #notifications a:hover{color:" + $SS.theme.linkHColor.hex + "!important}#header-bar,a.current{color:" + $SS.theme.headerColor.hex + "!important}#header-bar a:not(.current){color:" + $SS.theme.headerLColor.hex + "!important}#header-bar a:hover{color:" + $SS.theme.headerLHColor.hex + "!important}.postMessage>.quote,s:hover .quote,.str,.atv,.new{color:" + $SS.theme.quoteColor.hex + "!important}.subject,.replytitle,.teaser b,.post-subject,.option.header .option-title,.kwd{color:" + $SS.theme.titleColor.hex + "!important}.option.header{font-size:18px}.boardTitle{color:" + $SS.theme.boardColor.hex + "!important;text-shadow:1px 1px 1px rgba\(" + $SS.theme.boardColor.shiftRGB(-100) + ",.6)!important}.backlink{color:" + $SS.theme.blinkColor.hex + "!important}.prettyprint{background:none repeat scroll 0 0 rgba(" + $SS.theme.codeBackground + ")!important;border:1px solid rgba(" + $SS.theme.codeBorder + ")!important}.pun{color:rgba(" + $SS.theme.textColor.rgb + ",.4)!important}::-webkit-input-placeholder{color:rgba(" + $SS.theme.textColor.rgb + ",.4)!important}#qr .field::-moz-placeholder,::-moz-placeholder,#qr-no-file{color:rgba(" + $SS.theme.textColor.rgb + ",.4)!important}html,body{background:" + $SS.theme.bgImg.get() + $SS.theme.bgColor.hex + "!important}.reply,:root.catalog .panel,.dialog,.tab-label,#post-preview,.flashListing tr:nth-of-type(2n+1){background:rgba(" + $SS.theme.mainColor.rgb + "," + $SS.theme.replyOp + ")!important}:root.recolor-even .thread>.replyContainer:nth-of-type(even):not(.hidden) .post{background:rgb\(" + $SS.theme.mainColor.shiftRGB(-10) + ")!important}:root:not(.header-gradient) #header-bar{background:rgba(" + $SS.theme.headerBGColor.rgb + "," + $SS.theme.navOp + ")!important}:root.header-gradient #header-bar{background:linear-gradient(rgb\(" + $SS.theme.headerBGColor.shiftRGB(15) + "),rgba(" + $SS.theme.headerBGColor.rgb + "," + $SS.theme.navOp + "))!important}.options-button,.qr-link,.cataloglink,.pages strong>a{background:linear-gradient(rgb\(" + $SS.theme.mainColor.shiftRGB(15) + "),rgb(" + $SS.theme.mainColor.rgb + "))!important}.options-button:hover,.import-input:hover,.pages strong>a:hover{background:rgb\(" + $SS.theme.mainColor.shiftRGB(15) + ")}.focused.entry{background:rgb\(" + $SS.theme.mainColor.shiftRGB(10) + ")!important}.qr-link:hover{background:rgb\(" + $SS.theme.mainColor.rgb + ")}input:not(.jsColor),textarea,.riceCheck,#qr-filename-container{background:" + $SS.theme.inputColor.hex + "!important;transition:background .2s}input[type=checkbox],.riceCheck{background:rgb\(" + $SS.theme.inputColor.shiftRGB(20) + ")!important}input:not(.jsColor):hover,.riceCheck:hover,#qr-filename-container:hover,textarea:hover{background:rgb(" + $SS.theme.inputColor.hover + ")!important;transition:background .2s}hr{background-image:linear-gradient(to left,rgba(" + $SS.theme.brderColor.rgb + ",0),rgb(" + $SS.theme.brderColor.rgb + "),rgba(" + $SS.theme.brderColor.rgb + ",0))}#unread-line{background-image:linear-gradient(to left,rgba(" + $SS.theme.unreadColor.rgb + ",0),rgb(" + $SS.theme.unreadColor.rgb + "),rgba(" + $SS.theme.unreadColor.rgb + ",0))}.inline{background:rgba\(" + $SS.theme.mainColor.shiftRGB(-16) + ",.8)!important}:root.post-info .reply>.postInfo{background:rgba\(" + $SS.theme.mainColor.shiftRGB(-16) + ",.2)}.reply{border-width:0 1px 1px 0;border-style:solid}:root.borders-all .reply{border-width:1px}:root.borders-none .reply{border-width:0}:root.rounded-corners .reply,:root.rounded-corners .dialog:not(#header-bar),:root.rounded-corners .inline{border-radius:3px}:root.post-info .reply>.postInfo{border-bottom:1px solid rgb\(" + $SS.theme.mainColor.shiftRGB(4) + ")}:root.post-info.rounded-corners .reply>.postInfo{border-radius:3px 3px 0 0}.reply,.dialog,.entry,.inline,fieldset,#post-preview,.flashListing td:not(:last-of-type):not(.postblock){border-color:" + $SS.theme.brderColor.hex + "!important}input,textarea,.riceCheck,#qr-filename-container,#search-box,#index-search{border:1px solid " + $SS.theme.inputbColor.hex + "!important}.options-button,.qr-link,.cataloglink,.pages strong>a{border-style:solid;border-width:1px;border-color:rgb\(" + $SS.theme.mainColor.shiftRGB(-15) + ") rgb\(" + $SS.theme.mainColor.shiftRGB(-15) + ") rgb\(" + $SS.theme.mainColor.shiftRGB(-30) + ")!important}input:focus,textarea:focus,#qr-filename-container:focus{border:1px solid " + $SS.theme.linkColor.hex + "!important}#search-box:hover,#index-search:hover{border-color:" + $SS.theme.linkColor.hex + "!important}#header-bar{border:0!important}.flashListing td:not(:last-of-type):not(.postblock){border-width:1px;border-style:solid}.qphl{outline:2px solid rgba(" + $SS.theme.linkColor.rgb + ",.5)!important}#add-theme,#oneechan-options{border:0!important;border-radius:3px!important;position:fixed;margin:auto}#oneechan-options{width:900px;text-align:left!important;height:532px;top:0;bottom:0;left:0;right:0}.options-close,.options-container{padding:5px}.options-close{text-align:right!important}#add-mascot{height:208px;top:0;bottom:0;left:0;position:fixed;margin:auto;border:0!important;border-radius:3px!important;right:0;z-index:999!important;width:500px;text-align:right!important;padding:5px!important;box-shadow:0 1px 15px rgba(0,0,0,.3)!important}#add-theme{text-align:right!important;padding:20px!important;top:0;left:0;right:0;bottom:0;height:400px}:root.webkit #add-theme{height:403px!important}#add-mascot .option-title,#add-theme .option-title{float:left;line-height:22px;padding-left:5px}#add-mascot>label,#add-theme>label{line-height:22px}#options-container{border-radius:5px}#options-container,.options-section{height:500px}.options-section{overflow-y:auto;overflow-x:hidden}#main-section .option{display:block;border-top:1px solid rgba(0,0,0,.1);height:22px;padding:0 6px;vertical-align:middle}#main-section>.option:nth-of-type(even){background:rgb\(" + $SS.theme.mainColor.shiftRGB(-5) + ")!important}#main-section .buttons-container+.option{border-top:0!important}.option-title{line-height:20px!important}#main-section .option:first-child{border-top:0!important}#main-section .option:last-child{border-bottom:0!important}#main-section input,#main-section select{float:right!important}#main-section input[type=checkbox],#main-section .riceCheck{float:left!important;margin-right:5px!important}select[name='Font Family']>option{max-width:150px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.suboption::before{border-bottom:1px solid rgba(0,0,0,.1);border-left:1px solid rgba(0,0,0,.1);content:'';display:inline-block;float:left;margin-right:2px;height:50%;width:6px}.suboption{padding-left:16px!important}.option.header{cursor:auto!important}.theme-preview{cursor:default}#themes-section .reply{padding:2px!important;position:relative;text-align:left;width:99.4%;border-radius:0!important}.theme-buttons-container{bottom:4px;right:2px;margin:0;opacity:0;position:absolute;z-index:3}.theme-preview:hover .theme-buttons-container{opacity:1}.theme-buttons-container>a{display:inline-block;margin:0 2px;padding:2px 5px;text-align:center;width:50px;border-radius:3px}.theme-preview .sfw-label{bottom:-5px;font-size:32px!important;margin:0!important;opacity:0;position:absolute;right:300px}.theme-preview.selected:not(.nsfw) .sfw-label,.theme-preview.nsfw:not(.selected) .sfw-label,.theme-preview.nsfw.selected .both{transition:opacity .3s,right .3s}.theme-preview.nsfw .notsafe{opacity:1;right:3px;z-index:1}.theme-preview.selected .safe{opacity:1;right:3px;z-index:1}.theme-preview.selected.nsfw .sfw-label:not(.both){opacity:0!important;right:300px!important;z-index:0!important}.theme-preview.selected.nsfw .both{opacity:1;right:3px;z-index:1}:root.catalog blockquote{margin:12px 40px!important}#add-theme{text-align:left!important;width:800px!important}#add-theme>label{display:inline-block;text-align:right;width:33.3%}#add-theme>label#customCSS{width:100%}#add-theme>label#customCSS>textarea{height:110px;resize:vertical;width:100%}#add-theme>label>input[type=text],#add-theme>label>select{width:100px}#add-theme>div{margin-top:.6em;text-align:right}#mascot-section{text-align:center}.mascot-preview{background-position:center!important;background-repeat:no-repeat!important;background-size:contain!important;display:inline-block;height:257px;margin:2px;position:relative;width:210px;border-radius:10px;transition:all .1s}.mascot-preview:not(:hover) a:not(.mascot-name){opacity:0}.mascot-preview.selected{background-color:rgba(" + $SS.theme.linkColor.rgb + ",.6)!important;box-shadow:inset rgba(0,0,0,.15) 0 0 15px,rgba(" + $SS.theme.linkColor.rgb + ",.6) 0 0 2px}.mascot-preview a{color:#fff!important;padding:3px 8px;cursor:pointer;border-radius:2px;background:rgba(0,0,0,.6)}.mascot-preview a:hover{background:rgba(0,0,0,.8)}.mascot-link.edit{margin-left:1px}.mascot-buttons{position:absolute;left:0;right:0;bottom:10px}#mascot-buttons-container{padding:5px}.add-mascot-label{display:block}.mascot-input,.mascot-select{margin-top:1px!important;width:200px}.mascot-input.offset,.mascot-input.hoffset,.mascot-input.height,.mascot-input.width{width:80px}.add-mascot-label>input[type=checkbox],.add-mascot-label>.riceCheck{margin-top:5px}#options-tabs{list-style:none;margin:0;padding:0;position:absolute;top:-24px;left:-1px}.tab-item{float:left;margin:0;padding:0}.tab-label{display:block;height:16px;margin:0 1px;padding:5px;text-align:center;width:75px;border-radius:3px 3px 0 0;transition:all .1s ease-in-out}.tab-label:not(.selected):not(:hover){opacity:.8}#overlay2{background:rgba(0,0,0,.5);position:fixed;top:0;left:0;height:100%;width:100%;text-align:center;z-index:999!important}#overlay2::before{content:'';display:inline-block;height:100%;vertical-align:middle}#overlay.previewing{display:none}#overlay.previewing~#overlay2{background-color:rgba(0,0,0,.15)!important}#add-mascot+#overlay2{z-index:800!important}.buttons-container{bottom:3px;left:5px;position:absolute}.buttons-container{margin:0}.options-button{display:inline-block;line-height:18px;margin:0 2px;min-width:40px;padding:2px 10px;text-align:center;cursor:pointer;border-radius:3px}.options-button-small{padding:2px 5px;min-width:30px}#import-link{line-height:22px;overflow:hidden;position:relative;float:left;height:24px!important;margin-top:-2px;padding-top:2px}#import-settings{position:relative;overflow:hidden;vertical-align:bottom}#import-settings>.import-input{left:0}.import-input{position:absolute;opacity:0;cursor:pointer}label.option>input[type=checkbox],label.option>.riceCheck{margin:4px 2px 0!important;vertical-align:bottom!important}span.option>select,.option>input[type=text]{width:125px}#oneechan-options input[type=text],#oneechan-options select{max-height:20px;margin-top:1px!important;padding:1px 3px!important}#oneechan-options textarea{background:transparent!important;border:0!important;height:100%!important;width:100%!important;resize:none}#oneechan-version{opacity:.5;padding-right:5px;margin-left:160px}.link-delim{opacity:.4}#issues-link{padding-right:10px}.watch-thread-link{margin-bottom:-6px;margin-right:6px;top:auto!important;bottom:4px!important;background-image:url(\"data:image/svg+xml," + $SS.theme.icons.heart + "\")!important}:root.backlink-icon .backlink{background-image:url(\"data:image/svg+xml," + $SS.theme.icons.backlink + "\")!important;font-size:0!important;padding:6px!important;margin-right:0!important;opacity:.6!important;position:relative;bottom:5px;left:2px}:root.backlink-icon .reply .backlink{bottom:6px!important}:root.backlink-icon .backlink:hover,:root.backlink-icon .backlink.inlined{opacity:1!important}" + ($SS.conf["Sidebar Position"] !== 3 ? " :root:not(.fixed) #header-bar{z-index:10}:root.left-sidebar.fourchan-x body{padding-left:303px!important}:root.right-sidebar.fourchan-x body{padding-right:303px!important}.boardBanner{position:fixed}:root.left-sidebar .boardBanner{left:1px}:root.right-sidebar .boardBanner{right:1px}:root.fixed:not(.autohide):not(.bottom) .boardBanner{margin-top:auto}.bBanner{margin-bottom:40px}.bBanner::after{width:100%!important}.qr-link-container{margin-top:0}#qr{min-width:297px!important}:root.left-sidebar #qr{left:0!important;right:auto!important}:root.right-sidebar #qr{right:0!important;left:auto!important}:root.fixed.bottom:not(.autohide) #qr{margin-bottom:24px}.captcha-img,.captcha-img img{min-width:100%!important;height:56px!important}:root.ss-sidebar body::before{background:rgba\(" + $SS.theme.mainColor.shiftRGB(-18) + ",." + ($SS.theme.mainColor.isDark ? 9 : 2) + ");border-left:2px solid rgba(" + $SS.theme.mainColor.rgb + ",.9);box-shadow:inset " + $SS.theme.brderColor.hex + " 1px 0 0,inset " + $SS.theme.brderColor.hex + " -1px 0 0;content:'';height:100%;width:302px;position:fixed;top:0;right:0}:root.ss-sidebar.left-sidebar body::before{border-right:2px solid rgba(" + $SS.theme.mainColor.rgb + ",.9);border-left:0!important;left:0;right:auto!Important}" : "") + " :root.threadwatcher-tree #thread-watcher{top:0!important;left:0!important;bottom:0!important;max-width:52px!important;position:fixed!important;padding-left:0!important;padding-top:inherit!important;padding-bottom:inherit!important;padding-right:0!important;overflow:visible!important;white-space:nowrap;z-index:9!important;border:1px solid;box-shadow:none!important;min-width:15px;min-height:100%!important;display:block!important;word-spacing:-2px;margin-left:-3px!important}:root.threadwatcher-tree.fourchan-x body{padding-left:52px}:root.threadwatcher-tree #watcher-link{display:none!important}:root.threadwatcher-tree #thread-watcher .move{font-size:11px;overflow:hidden;white-space:normal;word-spacing:-2px;text-align:center;cursor:auto!important}:root.threadwatcher-tree #thread-watcher .close{display:none!important}:root.right-sidebar:root.threadwatcher-tree.fourchan-x body{padding-left:52px}:root.right-sidebar:root.threadwatcher-tree #thread-watcher{left:0!important;padding-left:0!important}:root.left-sidebar:root.threadwatcher-tree.fourchan-x body{padding-right:56px}:root.left-sidebar:root.threadwatcher-tree #thread-watcher{left:auto!important;right:0!important}:root.threadwatcher-tree #watched-threads{line-height:20px}:root.threadwatcher-tree #watched-threads a:nth-of-type(even):hover::after{content:attr(title);left:100%;margin-left:9px;position:absolute;padding:5px;margin-top:-7px;font-size:14px;color:" + $SS.theme.linkColor.hex + "!important;background:" + $SS.theme.mainColor.hex + "!important;border:2px solid " + $SS.theme.headerLColor.hex + "!important;border-radius:3px}:root.left-sidebar:root.threadwatcher-tree #watched-threads a:nth-of-type(even):hover::after{left:auto!important;right:100%!important;margin-right:9px}:root.threadwatcher-tree #watched-threads a:nth-of-type(even):hover::before{content:'';position:absolute;margin-left:26px;border:10px solid " + $SS.theme.headerLColor.hex + ";border-color:transparent " + $SS.theme.headerLColor.hex + " transparent transparent}:root.left-sidebar:root.threadwatcher-tree #watched-threads a:nth-of-type(even):hover::before{border-color:transparent transparent transparent " + $SS.theme.headerLColor.hex + "!important;left:auto;margin-left:-24px}" + $SS.theme.customCSS + "";
            if ($("#ch4SS").exists())
                $("#ch4SS").text(css);
            else
